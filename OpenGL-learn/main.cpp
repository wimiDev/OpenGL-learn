...
int main()
{
	...
	// -------------------------
	Shader shader("assets/scripts/glsl/vertex.vs", "assets/scripts/glsl/frament.fs");
	Shader shaderSingleColor("assets/scripts/glsl/fillcolor.vs", "assets/scripts/glsl/fillcolor.fs");
